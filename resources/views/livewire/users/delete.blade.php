<div>
    <form wire:submit="deleteUserByAdmin" class="p-6">

        <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
            {{ __('Are you sure you want to delete the user account for '.$user_name. ' ?') }}
        </h2>
        ...
        <div class="mt-6">
            <x-input-label for="passwordForDelete" value="{{ __('Password') }}" class="sr-only" />
